...
def transform_likes_per_minute():

    # The schema specifies the desired fields and datatypes from the
    # bluesky.events file. Then a dataframe df is created from the json file
    # containing these desired fields
